  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Любовь — это не то, что вы находите. Это то, что вы строите вместе,
          день за днём, выбирая друг друга снова и снова.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Алина &amp; Дмитрий</p>
          <p className="text-sm text-primary-foreground/60 mt-1">14 сентября 2026</p>
        </div>
      </div>
    </section>
  )
