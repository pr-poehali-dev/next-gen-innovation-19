...
const steps = [
  {
    ...
    title: "Сбор гостей",
    description:
      "Добро пожаловать! Гости собираются, звучит живая музыка, для всех приготовлено приветственное шампанское.",
  },
  {
    number: "14:00",
    title: "Церемония",
    description:
      "Торжественная роспись и обмен клятвами. Этот момент мы будем помнить всю жизнь — и очень хотим, чтобы вы были рядом.",
  },
  {
    number: "15:00",
    title: "Фотосессия",
    description:
      "Совместные фотографии с молодожёнами в саду. Лёгкие закуски и напитки для гостей.",
  },
  {
    number: "16:00",
    title: "Банкет",
    description:
      "Праздничный ужин, тосты, первый танец молодожёнов и танцы до утра. Вечер, который останется в сердце навсегда.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Расписание
                <span className="italic"> торжества</span>
              </h2>
              <p
              ...
              >
                Каждая минута этого дня наполнена смыслом. Мы хотим, чтобы вы чувствовали себя комфортно
                и знали, что вас ждёт.
              </p>
            </div>
          </div>
